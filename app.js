const quotes = [
    {
        ...
        quote: `"I’ve missed more than 9000 shots in my career. I’ve lost almost 300 games. 26 times 
...
function changeQuote(){
    let tempp = newQuote(quoteElement.innerText);
    quoteElement.innerText = tempp.quote;
    authorElement.innerText = tempp.author;    
}

function newQuote(q){
    let temp = quotes[[Math.floor(Math.random()*quotes.length)]]
    if(temp.quote == q){
        return changeQuote(q);
    }    
    return temp;
}